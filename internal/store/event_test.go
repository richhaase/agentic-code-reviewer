...
func TestReviewEventV1_AllVocabularyTypesRoundTripAndValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "review queued", event: ReviewEventV1{Type: EventTypeReviewQueued, RunID: "run-1", HeadObjectID: "head-1"}},
		{name: "review started", event: ReviewEventV1{Type: EventTypeReviewStarted, RunID: "run-1", HeadObjectID: "head-1"}},
		{name: "review completed", event: ReviewEventV1{Type: EventTypeReviewCompleted, RunID: "run-1", HeadObjectID: "head-1"}},
		{name: "review failed", event: ReviewEventV1{Type: EventTypeReviewFailed, RunID: "run-1", HeadObjectID: "head-1", Reason: "all reviewers failed"}},
		{name: "review interrupted", event: ReviewEventV1{Type: EventTypeReviewInterrupted, RunID: "run-1", HeadObjectID: "head-1"}},
		{name: "review superseded", event: ReviewEventV1{Type: EventTypeReviewSuperseded, RunID: "run-1", HeadObjectID: "head-1"}},
