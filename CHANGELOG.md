...
- Add semantic validation of resolved config in `acr config validate` (#158)

## Maintenance

- Bump actions/setup-go from 5 to 6 (#142)
- Bump actions/upload-artifact from 4 to 6 (#144)
- Bump actions/checkout from 4 to 6 (#145)
- Remove unrelated section from release skill (#157)
- Remove CHANGELOG.md and simplify release process (#156)
